...
export const Events = {
    ...
    setup: () => {
        ...
        // ends above, so it was never in scope: the feature never worked, and it
        // ran once at setup instead of per click. It survived only because the
        // `openDropdown &&` short-circuit ran first — had any .dropdown-menu.show
        // existed at startup it would have thrown, and every listener registered
        // below (stats, forms, drag-and-drop, FAB, keyboard) would silently never
        // attach. Removed rather than fixed: nothing in the app renders
        // .dropdown-menu.show today.
